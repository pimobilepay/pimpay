        ...
        >
          <div className="flex flex-col h-full">
            ...
            <div className="p-6 pt-12 pb-8 bg-gradient-to-br from-blue-600/10 to-transparent relative">
              <button
                onClick={onClose}
                className="absolute top-4 right-4 p-2 rounded-full bg-white/5 hover:bg-white/10 text-slate-400"
              >
                <X size={18} />
              </button>
                  ...
                  <div className="flex flex-col gap-1">
                    {group.items.map((item, iIdx) => (
                      <button
                        ...
                        className="group flex items-center justify-between p-3.5 rounded-2xl hover:bg-white/5 text-slate-300"
                      >
                        <div className="flex items-center gap-3">
                          <div className="p-2 rounded-xl bg-slate-900 group-hover:bg-slate-800">
                            {item.icon}
                          </div>
            ...
            <div className="p-6 border-t border-white/5 bg-slate-950/50">
              <button
                onClick={logout}
                className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl font-bold bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white transition-all"
              >
                <LogOut size={18} />
                Déconnexion
              </button>

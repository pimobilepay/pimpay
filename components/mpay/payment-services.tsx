...
const SERVICES: PaymentService[] = [
  ...
  { id: "taxi", name: "Taxi", description: "Commander un taxi et payer votre course", features: ["Carte", "Position GPS", "Paiement MPay", "Historique"], icon: Car, gradient: "from-yellow-500 to-amber-600", glow: "shadow-yellow-500/30", route: "/mpay/taxi" },

...
export default function UserDashboard() {
  ...
  const getTransactionUI = (tx: any, currentUserId: string) => {
    const isReceived = tx.type === 'DEPOSIT' || tx.toUserId === currentUserId || tx.receiverId === currentUserId;
    
    // Détermination de l'icône et couleur selon le type (SWAP, TOPUP ou TRANSFER)
    if (tx.type === 'SWAP') {
      return {
    ...
    return {
      ...
      label: isReceived ? "Vente reçue" : "Paiement envoyé"
    };
  };
    ...
    <div className="min-h-screen bg-[#020617] text-white pb-32 font-sans">
      ...
      <main className="px-6 animate-in fade-in duration-700">
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            ...
            <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                    <p className="text-[10px] text-white/40 font-bold uppercase tracking-widest">Vendeur:</p>
            ...
            <div className="flex justify-between items-end">
                ...
                <div className="text-right">
                    <p className="text-[8px] font-black text-white/30 uppercase tracking-[0.2em]">Réseau</p>
        ...
        <div className="grid grid-cols-4 gap-4 mb-10">
            {[{ icon: <ArrowUpRight />, label: "Vendre", color: "bg-blue-600", link: "/transfer" },
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            {transactions.length > 0 ? transactions.map((tx: any) => {
              ...
              <div className="text-center py-10 opacity-30 text-[10px] uppercase font-bold border border-dashed border-white/10 rounded-[32px]">Aucune vente enregistrée</div>
            )}
          </div>
        </section>
      </main>

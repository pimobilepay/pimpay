  ...
  const sections = [
    {
      ...
      content:
        "Cette Politique de Confidentialité décrit comment PIMOBIPAY collecte, utilise, protège et partage vos informations personnelles lorsque vous utilisez nos services numeriques. PIMOBIPAY est une plateforme fintech web3  multi-chaines integrée aux écosystèmes Sidra Chain et Pi Network, opérant en conformité avec les standards SMIIC, AAOIFI et les principes de la finance islamique.",
    },
    {
    ...
    <div className="min-h-screen bg-[#020617] text-white pb-32 font-sans">
      <div className="p-6 pt-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <h1 className="text-xl font-black uppercase tracking-tighter italic">
            PIMOBIPAY <span className="text-blue-500">Privacy</span>
          </h1>
        ...
        <div className="mb-8 bg-slate-900/60 border border-white/5 rounded-2xl p-4">
          ...
          <p className="text-xs text-slate-400 leading-relaxed">
            Cette politique s'applique a tous les services PIMOBIPAY, incluant les wallets multi-devises (XAF, EUR, USD, CDF, Pi, Sidra), les cartes virtuelles, les transactions blockchain (Sidra Chain, Pi Network, USDT TRC20) et l'ensemble des fonctionnalites de la plateforme.
          </p>
        </div>
      </div>
      ...
      <div className="mt-8 text-center px-6">
        <p className="text-[8px] font-black text-slate-700 uppercase tracking-[0.3em]">
          Data Protection Officer - PIMOBIPAY Protocol
        </p>

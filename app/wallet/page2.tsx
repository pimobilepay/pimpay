...
import {
  ...
  ArrowUpRight, ArrowDownLeft, RefreshCcw, ArrowLeftRight, ShieldAlert, History, Plus
} from "lucide-react";
...
export default function WalletPage() {
  ...
  const loadWalletData = async () => {
    try {
      ...
      // Utilisation de l'API /api/user/profile qui fonctionne sur ton dashboard
      ...
      if (res.ok) {
        ...
        // L'API profile renvoie directement l'objet avec balance, name, etc.
        setData(result);
        ...
        <div className="group relative w-full aspect-[1.58/1] mb-6">
          <div className="w-full h-full bg-gradient-to-br from-blue-600 to-indigo-900 rounded-[32px] p-8 border border-white/20 shadow-2xl relative overflow-hidden">
            ...
            <div className="mt-8 relative z-10 flex items-center justify-between">
              ...
              <button onClick={() => setShowCardNumber(!showCardNumber)} className="text-white/40">

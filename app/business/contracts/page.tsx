...
const CONTRACTS: Contract[] = [
  ...
  { id: 'CTR-2024-006', title: 'Partenariat Mobile Money Orange', partner: 'Orange Cameroun', type: 'partenariat', startDate: '2023-06-01', endDate: '2024-05-31', value: 35000000, status: 'actif', description: 'Accord de partenariat pour l\'intégration Orange Money dans la plateforme PIMOBIPAY.', terms: 'Commission 1.2% par transaction. Volume minimum 10 000 transactions/mois.',
  ...
  { id: 'CTR-2023-011', title: 'Accord de distribution UBA', partner: 'UBA Cameroun', type: 'partenariat', startDate: '2023-03-01', endDate: '2024-02-28', value: 45000000, status: 'resilie', description: 'Accord de distribution des services PIMOBIPAY via le réseau UBA.', terms: 'Résiliation anticipée par accord mutuel.',

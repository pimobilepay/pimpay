...
<a href="https://cg.linkedin.com/in/aimardswana" target="_blank" rel="noopener noreferrer" className={`p-4 rounded-2xl ${isDarkMode ? 'bg-slate-900/40' : 'bg-white shadow-sm'} text-slate-400 hover:text-blue-500 transition-colors shadow-lg active:scale-90`}>
  <Linkedin size={24} />
                ...
                <a href="https://youtube.com/@pimpayofficial" target="_blank" rel="noopener noreferrer" className={`p-4 rounded-2xl ${isDarkMode ? 'bg-slate-900/40' : 'bg-white shadow-sm'} text-slate-400 hover:text-red-500 transition-colors shadow-lg active:scale-90`}>

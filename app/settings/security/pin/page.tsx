...
export default function ChangePinPage() {
    ...
    if (step === 1) {
      ...
      try {
        ...
        if (res.ok) {
          ...
          setShake(true);
          setTimeout(() => setShake(false), 500);
          setError(data.error || "Ancien code PIN incorrect");
  ...
  const subtitles = ["", "Verification de securite", "Choisissez 6 chiffres", "Confirmez votre nouveau code"];
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white flex flex-col font-sans">
      ...
      <div className="px-6 pt-12 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tight">Securite PimPay</h1>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8">
        <div className={`w-full max-w-md space-y-6 ${shake ? "animate-shake" : ""}`}>
          ...
          <div className="flex justify-center gap-3 py-4">
            {[0, 1, 2, 3, 4, 5].map((i) => {
              const active = pins[step as 1 | 2 | 3].length > i;
              return (
                <motion.div
                  key={i}
                  initial={{ scale: 0.8 }}

                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {walletInfo && (
                          <span className={`text-[7px] font-bold px-1.5 py-0.5 rounded ${
                            String(walletInfo.wallet) === "admin" ? "bg-amber-500/20 text-amber-400" :
                            String(walletInfo.wallet) === "treasury" ? "bg-blue-500/20 text-blue-400" :
                            String(walletInfo.wallet) === "hot" ? "bg-orange-500/20 text-orange-400" :

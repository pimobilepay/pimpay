                ...
                <CardContent className="space-y-4">
                  <div className="p-4 rounded-2xl bg-slate-800/50 border border-white/5">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <Button variant="outline" size="sm" className="border-white/10 text-xs font-bold shrink-0">
                        Copier
                      </Button>
                    </div>
                  </div>
            ...
            <Card className="bg-slate-900/50 border-white/5 rounded-3xl">
              ...
              <CardContent className="space-y-6">
                <div className="p-4 rounded-2xl bg-slate-800/50 border border-white/5">
                  ...
                  <code className="text-xs text-emerald-400 bg-slate-900/50 px-3 py-2 rounded-lg block">
                    https://api.pimpay.com/v1
                  </code>
                </div>
                <div className="p-4 rounded-2xl bg-slate-800/50 border border-white/5">
                  <p className="text-sm font-bold text-white mb-2">Endpoint Sandbox</p>
                  <code className="text-xs text-amber-400 bg-slate-900/50 px-3 py-2 rounded-lg block">

            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3.5 text-sm font-semibold focus:outline-none focus:border-blue-500/50 transition-colors placeholder:text-slate-700"
                  value={formData.name}
              ...
              <div className="space-y-1.5">
                ...
                <textarea 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl px-4 py-3.5 text-sm font-semibold focus:outline-none focus:border-blue-500/50 transition-colors placeholder:text-slate-700 resize-none"

...
export const worldCountries: Country[] = [
  ...
  { name: "Sudan",              code: "SD", flag: "🇸🇩", currency: "SDG", currencySymbol: "ج.س",  piToLocalRate: 600,   dialCode: "+249",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "South Sudan",        code: "SS", flag: "🇸🇸", currency: "SSP", currencySymbol: "£",    piToLocalRate: 1300,  dialCode: "+211",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Somalia",            code: "SO", flag: "🇸🇴", currency: "SOS", currencySymbol: "Sh",   piToLocalRate: 571,   dialCode: "+252",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Djibouti",           code: "DJ", flag: "🇩🇯", currency: "DJF", currencySymbol: "Fdj",  piToLocalRate: 178,   dialCode: "+253",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Eritrea",            code: "ER", flag: "🇪🇷", currency: "ERN", currencySymbol: "Nfk",  piToLocalRate: 15,    dialCode: "+291",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Burundi",            code: "BI", flag: "🇧🇮", currency: "BIF", currencySymbol: "FBu",  piToLocalRate: 2870,  dialCode: "+257",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Malawi",             code: "MW", flag: "🇲🇼", currency: "MWK", currencySymbol: "MK",   piToLocalRate: 1730,  dialCode: "+265",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Zimbabwe",           code: "ZW", flag: "🇿🇼", currency: "ZWG", currencySymbol: "Z$",   piToLocalRate: 13.5,  dialCode: "+263",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Botswana",           code: "BW", flag: "🇧🇼", currency: "BWP", currencySymbol: "P",    piToLocalRate: 13.6,  dialCode: "+267",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Namibia",            code: "NA", flag: "🇳🇦", currency: "NAD", currencySymbol: "$",    piToLocalRate: 18.5,  dialCode: "+264",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Lesotho",            code: "LS", flag: "🇱🇸", currency: "LSL", currencySymbol: "L",    piToLocalRate: 18.5,  dialCode: "+266",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Eswatini",           code: "SZ", flag: "🇸🇿", currency: "SZL", currencySymbol: "L",    piToLocalRate: 18.5,  dialCode: "+268",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Mauritius",          code: "MU", flag: "🇲🇺", currency: "MUR", currencySymbol: "₨",    piToLocalRate: 46,    dialCode: "+230",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Seychelles",         code: "SC", flag: "🇸🇨", currency: "SCR", currencySymbol: "₨",    piToLocalRate: 13.5,  dialCode: "+248",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Comoros",            code: "KM", flag: "🇰🇲", currency: "KMF", currencySymbol: "CF",   piToLocalRate: 450,   dialCode: "+269",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Cape Verde",         code: "CV", flag: "🇨🇻", currency: "CVE", currencySymbol: "$",    piToLocalRate: 101,   dialCode: "+238",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Guinea-Bissau",      code: "GW", flag: "🇬🇼", currency: "XOF", currencySymbol: "FCFA", piToLocalRate: 605.5, dialCode: "+245",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Gambia",             code: "GM", flag: "🇬🇲", currency: "GMD", currencySymbol: "D",    piToLocalRate: 68,    dialCode: "+220",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Sierra Leone",       code: "SL", flag: "🇸🇱", currency: "SLE", currencySymbol: "Le",   piToLocalRate: 22,    dialCode: "+232",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Liberia",            code: "LR", flag: "🇱🇷", currency: "LRD", currencySymbol: "$",    piToLocalRate: 192,   dialCode: "+231",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Mauritania",         code: "MR", flag: "🇲🇷", currency: "MRU", currencySymbol: "UM",   piToLocalRate: 39.7,  dialCode: "+222",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Central African Republic", code: "CF", flag: "🇨🇫", currency: "XAF", currencySymbol: "FCFA", piToLocalRate: 605.5, dialCode: "+236", continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Equatorial Guinea",  code: "GQ", flag: "🇬🇶", currency: "XAF", currencySymbol: "FCFA", piToLocalRate: 605.5, dialCode: "+240",  continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },
  { name: "Sao Tome and Principe", code: "ST", flag: "🇸🇹", currency: "STN", currencySymbol: "Db", piToLocalRate: 22.5, dialCode: "+239", continent: "AFRICA", isoStandard: "ISO20022", isActive: false, banks: [], operators: [] },

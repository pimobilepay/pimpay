...
export const PERMISSIONS = {
  ...
  AIRDROP_VIEW: "airdrop.view",
  AIRDROP_MANAGE: "airdrop.manage",
  RBAC_VIEW: "rbac.view",
...
export const PERMISSION_LABELS: Record<PermissionKey, string> = {
  ...
  "airdrop.view": "Voir les airdrops & bonus",
  "airdrop.manage": "Distribuer les airdrops & bonus",
...
export const ROLE_PRESETS: Record<string, { label: string; permissions: PermissionKey[] }> = {
  ...
  FINANCE: {
    ...
    permissions: [
      ...
      PERMISSIONS.AIRDROP_VIEW,
      PERMISSIONS.AIRDROP_MANAGE,
    ],
  },
  SUPPORT: {
    label: "Support N2",
